...
class BotConfig:
    ...
    Attributes:
        ...
        STOCK_API_TIMEOUT_SECONDS: Stock API timeout in seconds.
        ...
        STOCK_TICKER_COOLDOWN_RATE: Max ticker lookups per window.
        STOCK_TICKER_COOLDOWN_PER_SECONDS: Ticker cooldown window in seconds.
        STOCK_INFO_COOLDOWN_RATE: Max stock info requests per window.
        STOCK_INFO_COOLDOWN_PER_SECONDS: Stock info cooldown window in seconds.
    ...
    STOCK_API_TIMEOUT_SECONDS: int = 15
    ...
    STOCK_TICKER_COOLDOWN_RATE: int = 1
    STOCK_TICKER_COOLDOWN_PER_SECONDS: int = 15
    STOCK_INFO_COOLDOWN_RATE: int = 1
    STOCK_INFO_COOLDOWN_PER_SECONDS: int = 20
